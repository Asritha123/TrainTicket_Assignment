package com.trainticket.client;
...
import com.trainticket.bean.Passenger;
...
20
	...
	public class TicketApplication {
		...
		public void writeTicket() throws Exception
		  {
		    File f = new File("D:/Teja/Desktop/Teja/TrainTicketUseCase/"+generatePNR()+".txt");
		    ...
		    br.close();
		    fr.close();
		    System.out.println("Ticket Booked with PNR : "+generatePNR()+".txt");
